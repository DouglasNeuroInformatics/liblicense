...
type CustomLicenseIdentifier = Extract<keyof typeof customLicenses, string>;

type SPDXLicenseIdentifier = Extract<keyof typeof spdxLicenses, string>;

type LicenseIdentifier = CustomLicenseIdentifier | SPDXLicenseIdentifier;
...
} as const satisfies { [key: string]: License };
...
export type { License, LicenseIdentifier };
